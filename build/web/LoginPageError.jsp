<%-- 
    Document   : LoginError
    Created on : 19-Oct-2022, 6:24:54 pm
    Author     : KAAVIASUDHAN
--%>
...
<html>
    ...
    <body style="background-image: url('https://i.postimg.cc/q7vVkKp5/bg-img.jpg'); background-repeat: no-repeat; background-size: 100%;">
        ...
        <br><br><br>
        <div class="container">
            <div style="text-align:center"><h1><b>VSKS QUIZ SYSTEM</b></h1></div>
            <br>
            <form name="form" action="LoginServlet" method="post" onsubmit="return validate()">
                ...
                <table align="center">
                    ...
                    <tr> 
                        <td><h4 style="color: red;">Invalid Username or Password</h4></td>
                    </tr>
                    <tr></tr>
                    <tr>
                    <td></td>
            ...
            <br><br>
            <center>
                <a href="Register.jsp"><button class="button button2">Register as a new User</button><br><br>
            </center>
        </div>
    </body>
</html>
